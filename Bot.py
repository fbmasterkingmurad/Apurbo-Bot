...
import cloudscraper 
import pyotp
import threading # Keep-alive এর জন্য যুক্ত করা হয়েছে
from flask import Flask # হোস্টিং এ সচল রাখার জন্য
...
ACCOUNTS = [
    ...
    {"email": "kmssrti69@gmail.com", "pass": "Murad@69"}
]
...
if __name__ == '__main__':
    # সার্ভার সচল রাখার মেকানিজম চালু করা হলো
    keep_alive() 
    ...
    print("🚀 Bot LIVE with Keep-Alive System!")
